...
if("FALSE" STREQUAL "TRUE")
  set(pir_SOURCE_PREFIX /home/invite/Documents/PIR3/pir_robot/catkin_ws/src/pir)
  set(pir_DEVEL_PREFIX /home/invite/Documents/PIR3/pir_robot/catkin_ws/devel)
  set(pir_INSTALL_PREFIX "")
  set(pir_PREFIX ${pir_DEVEL_PREFIX})
else()
  set(pir_SOURCE_PREFIX "")
  set(pir_DEVEL_PREFIX "")
  set(pir_INSTALL_PREFIX /home/invite/Documents/PIR3/pir_robot/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'pir' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'pierre <pierre@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'pir' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/invite/Documents/PIR3/pir_robot/catkin_ws/install/${idir}'.  Ask the maintainer 'pierre <pierre@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/invite/Documents/PIR3/pir_robot/catkin_ws/install/lib;/opt/ros/indigo/lib)
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${pir_dep}_FOUND)
      find_package(${pir_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${pir_dep} REQUIRED ${depend_list})
  endif()
