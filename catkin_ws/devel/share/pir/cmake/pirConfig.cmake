...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pir' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/invite/Documents/PIR3/pir_robot/catkin_ws/src/pir/${idir}'.  Ask the maintainer 'pierre <pierre@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/invite/Documents/PIR3/pir_robot/catkin_ws/devel/lib;/opt/ros/indigo/lib)
